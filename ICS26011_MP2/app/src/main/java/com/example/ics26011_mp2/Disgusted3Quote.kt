...
class Disgusted3Quote : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_disgusted3_quote)
        ...
        back.setOnClickListener {
            if(messageFrom=="No Thanks") { startActivity(Intent(this, Disgusted1Question::class.java)) }
            else if(messageFrom=="Sure") {
                val intent = Intent(this, Disgusted2Feeling::class.java).also{
        ...
        quote.apply {
            ...
            else { text = "Quote about feeling Disgusted" }
        }
    }
