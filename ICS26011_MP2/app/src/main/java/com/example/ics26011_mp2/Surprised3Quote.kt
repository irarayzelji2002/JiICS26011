...
class Surprised3Quote : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_surprised3_quote)
        ...
        back.setOnClickListener {
            if(messageFrom=="No Thanks") { startActivity(Intent(this, Surprised1Question::class.java)) }
        ...
        quote.apply {
            ...
            else { text = "Quote about feeling Surprised" }
        }
    }
