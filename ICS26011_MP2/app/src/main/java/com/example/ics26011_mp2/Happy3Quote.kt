...
class Happy3Quote : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_happy3_quote)
        ...
        back.setOnClickListener {
            if(messageFrom=="No Thanks") { startActivity(Intent(this, Happy1Question::class.java)) }
            else if(messageFrom=="Sure") {
                val intent = Intent(this, Happy2Feeling::class.java).also{
        ...
        quote.apply {
            ...
            else { text = "Quote about feeling Happy" }
        }
    }
