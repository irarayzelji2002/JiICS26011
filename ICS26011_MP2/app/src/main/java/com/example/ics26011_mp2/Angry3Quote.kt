...
class Angry3Quote : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_angry3_quote)
        ...
        back.setOnClickListener {
            if(messageFrom=="No Thanks") { startActivity(Intent(this, Angry1Question::class.java)) }
        ...
        quote.apply {
            ...
            else { text = "Quote about feeling Angry" }
        }
    }
