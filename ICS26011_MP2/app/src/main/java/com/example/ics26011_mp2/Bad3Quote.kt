...
class Bad3Quote : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bad3_quote)
        ...
        back.setOnClickListener {
            if(messageFrom=="No Thanks") { startActivity(Intent(this, Bad1Question::class.java)) }
            else if(messageFrom=="Sure") {
                val intent = Intent(this, Bad2Feeling::class.java).also{
        ...
        quote.apply {
            ...
            else { text = "Quote about feeling Bad" }
        }
    }
